...
<form action="vote.php" method="get" target='hero' class="form-opros">

<input type="Hidden" name="id" value="1">
<div class="question">Воспользуетесь ли нашеми услугами снова?</div>
<div class="radio">
    <input class="custom-radio" type="radio" id="color-1" name="vote" value="1" checked>
    <label for="color-1">Да</label>
  </div>

  <div class="radio">
    <input class="custom-radio" type="radio" id="color-2" name="vote" value="2">
    <label for="color-2">Возможно</label>
  </div>
  <div class="radio">
    <input class="custom-radio" type="radio" id="color-3" name="vote" value="3">
    <label for="color-3">Не знаю</label>
  </div>

  <div class="radio">
    <input class="custom-radio" type="radio" id="color-4" name="vote" value="4">
    <label for="color-4">Нет</label>
  </div>
<input type="Submit" value=" Результаты" style="margin-top:10px;">
